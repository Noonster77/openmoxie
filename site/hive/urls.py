...
urlpatterns = [
    ...
    path("transcript_manage/<int:pk>", views.transcript_manage, name="transcript_manage"),
    ...
    path("joke_settings/<int:pk>", views.JokeSettingsView.as_view(), name="joke_settings"),
    path("joke_configure/<int:pk>", views.joke_configure, name="joke_configure"),
